...
import { M as MARATHON_KM } from "./router-BVyf5xBN.mjs";
import { g as metaPatrimonio, t as taxaMensal, h as aporteAtMonth, j as eventoAtMonth } from "./math-5GrSvXuq.mjs";
import { i as TrendingUp, j as Timer } from "../_libs/lucide-react.mjs";
...
function calcularPace(plan, derived) {
  ...
  const kmProx = kmAtualVisivel >= MARATHON_KM ? MARATHON_KM : Math.min(MARATHON_KM, Math.floor(kmAtualVisivel) + 1);
...
function fmtMeses(meses) {
  ...
  if (meses < 12) {
    const v2 = meses.toFixed(1).replace(/\.0$/, "");
    return `${v2} meses`;
  }
  const anos = meses / 12;
...
function PaceCard({ pace, bare }) {
  ...
  const content = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground leading-snug", children: "Quanto tempo você levou para fazer o último km e quanto deve levar para o próximo, mantendo aporte e taxa do plano." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-secondary/40 p-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider text-muted-foreground", children: "Último km" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 flex items-baseline gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-wider text-muted-foreground", children: "km" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-bold tabular-nums leading-none", children: formatKmMarker(kmUltimo) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold tabular-nums mt-2", children: pace.mesesUltimoKm !== null ? fmtMeses(pace.mesesUltimoKm) : "—" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground mt-0.5", children: pace.mesesUltimoKm !== null ? `tempo no km ${formatKmMarker(kmUltimo)} antes de chegar ao ${formatKmMarker(kmUltimoFim)}` : "série insuficiente p/ medir esse km" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-secondary/40 p-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 flex items-baseline gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-wider text-muted-foreground", children: "km" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-bold tabular-nums leading-none text-pace-on", children: formatKmMarker(kmProxFim) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold tabular-nums mt-2 text-pace-on", children: pace.mesesProxKm !== null ? `≈ ${fmtMeses(pace.mesesProxKm)}` : "—" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rounded-2xl border border-border/60 bg-card p-4", children: [
