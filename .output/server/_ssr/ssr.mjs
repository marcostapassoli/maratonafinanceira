...
import { C as invariant, _ as executeRewriteInput, a as RouterProvider, b as rootRouteId, g as resolveManifestAssetLink, t as renderRouterToStream, v as isRedirect, x as isNotFound, y as isResolvedRedirect } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BlABjHkR.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DuEozytO.mjs").then((n) => n.t),
